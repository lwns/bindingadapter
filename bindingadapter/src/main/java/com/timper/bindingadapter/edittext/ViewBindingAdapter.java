...
public final class ViewBindingAdapter {
  ...
  public static void editTextCommand(EditText editText, final ParamCommand<TextChangeDataWrapper> beforeTextChangedCommand,
      final ParamCommand<TextChangeDataWrapper> onTextChangedCommand, final ParamCommand<String> afterTextChangedCommand) {
