...
public class LoadingView extends View {
  ...
  private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    mMinWidth = dip2px(48);
    mMaxWidth = dip2px(48);
    mMinHeight = dip2px(48);
    mMaxHeight = dip2px(48);
    ...
    String indicatorName = TextUtils.isEmpty(a.getString(R.styleable.loading_indicatorName)) ? "LoadingIndicator"
      : a.getString(R.styleable.loading_indicatorName);
